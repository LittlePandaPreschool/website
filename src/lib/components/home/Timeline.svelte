  ...
  <div class="container mx-auto px-6">
    ...
    <div class="relative max-w-2xl mx-auto">
      ...
      {#each items as item, i}
        <div
          class="mb-8 flex items-center w-full timeline-item transform transition-transform duration-300 hover:scale-105"
          bind:this={elements[i]}
        >
          <div class="z-20 flex-shrink-0">
            <div class="h-8 w-8 {item.dotColor} rounded-full"></div>
          </div>
          <div class="bg-white rounded-lg shadow-md ml-8 p-6 w-full transition-shadow duration-300 hover:shadow-xl">
